...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" Runat="Server">
    <div class="container-full-width container-vert-padding container-bg-city">
        <div class="copy copy-narrow text-center">
            <h2 class="heading heading-primary">Who are we?</h2>
            <h3 class="heading heading-subtitle">Passionate designers and developers who enjoy and excel at creating the best web experiences imaginable. We are recognized as industry experts on up-and-coming web trends, platforms, and applications. </h3>
        </div>
    </div>
    <div class="container-full-width container-vert-padding container-bg-white container-cols-2">
        <div class="container copy eq-height">
            <div class="col border-right border-right-orange eq-height-item copy-default">
                ...
                <p>Select Interactive is led by developers <a href="mailto:jeremy@select-interactive.com">Jeremy Burton</a> and <a href="danh@select-interactive.com">Dan Harris</a>. Jeremy is the lead developer for each project and directs all development and technology strategy within the team.</p>
