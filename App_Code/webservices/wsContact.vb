...
Public Class wsContact
    ...
    Public Function submitContactRequest(ByVal inquiry() As String,
        ...
        smtp.Host = "smtp.sendgrid.net"
            ...
            Dim mm As New MailMessage("""Select Interactive CRE"" <contact@select-interactive.com>", "jeremy@select-interactive.com")
            With mm
                .Body = body
                .IsBodyHtml = True
                .Subject = "Select Interactive CRE Contact Request"
            End With
